...
BASE_ROUTES=leaderboard/data/failed2_3_qw_tj
...
BASE_CHECKPOINT_ENDPOINT=resume_0112_220_3
...
bash leaderboard/scripts/runqwen.sh $PORT $TM_PORT $IS_BENCH2DRIVE $ROUTES $TEAM_AGENT $TEAM_CONFIG $CHECKPOINT_ENDPOINT $SAVE_PATH $PLANNER_TYPE $GPU_RANK
